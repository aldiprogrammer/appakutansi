                            ...
                            <form action="{{ route('user.create') }}" method="post">
                                <div class="modal-body">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="password" class="form-control" name="passwowrd">
            ...
            <table class="table table-striped mt-5">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <button id="hapus" class="btn btnhapus" data-id="{{ $item->id }}" data-url='hapususer'><i class="fas fa-trash"></i></button>
                            ...
                            <div class="modal-content">
                                ...
                                <form action="{{ route('user.update', $item->id) }}" method="post">
                                    <div class="modal-body">
                                        ...
                                        <div class="mb-3">
                                            <label class="form-label">Username</label>
                                            <input type="text" class="form-control" value="{{ $item->username }}" name="username" required>
                                        </div>

                                        <div class="mb-3">
                                            <label class="form-label">Wilayah</label>
                                            <select name="wilayah" id="" class="form-control">
                                                <option value="{{ $item->id_wilayah }}">{{ $item->wilayah->wilayah }}</option>
                                                @foreach ($data['wilayah'] as $wl )
                                                <option value="{{ $wl->id }}">{{$wl->wilayah }}</option>
                                                @endforeach
                                            </select>
                                        ...
                                        <div class="mb-3">
                                            <label class="form-label">Level</label>
                                            <select name="level" id="" class="form-control">
                                                <option value="{{ $item->id_level }}">{{ $item->level->level }}</option>
                                                @foreach ($data['level'] as $lv )
                                                <option value="{{ $lv->id }}">{{$lv->level }}</option>
                                                @endforeach
                                            </select>
